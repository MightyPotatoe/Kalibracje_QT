...
void MainWindow::on_proceed_button_clicked()
{
   ...
   if(!plikRka.is_open()){
       ...
       secondWindow * w = new secondWindow(this, patch, device, rName);
       hide();
       w->show();
   }
}
